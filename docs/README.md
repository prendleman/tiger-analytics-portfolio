...
| [MODEL_CARD_TIMESERIES.md](MODEL_CARD_TIMESERIES.md) | PMPM time series models: SARIMA, Prophet, evaluation |
| [RESULTS.md](RESULTS.md) | Typical metrics on demo data (AUC, MAPE, etc.) |
| [TROUBLESHOOTING.md](TROUBLESHOOTING.md) | Common issues and fixes |

Notebooks: run `python scripts/export_notebooks.py` to generate HTML in `docs/notebooks/` for static viewing.
